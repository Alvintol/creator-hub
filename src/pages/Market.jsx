...
const Market = () => {
    ...
    const filtered = useMemo(() => {
        ...
        return listings.filter((l) => {
            ...
            const hay = [l.title, l.short, l.category, ...(l.tags || []), c?.displayName || ""]
                .join(" ")
                .toLowerCase();
    ...
    return (
        <div className="space-y-5">
            <div>
                ...
                <p className="mt-1 text-sm text-zinc-600">Digital packs + commission offerings.</p>
            </div>
                        ...
                        >
                            ...
                            <div className="p-4">
                                ...
                                <div className="mt-3 flex items-center justify-between text-sm">
                                    ...
                                    <span className="text-zinc-600">{c?.displayName ?? l.creatorHandle}</span>
                                </div>
                            </div>
                        </Link>
                    );
