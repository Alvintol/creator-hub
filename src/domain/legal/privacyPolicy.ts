...
export const privacySections = [
  {
    ...
    "body": [
      "Made for Stream is operated by Made for Stream (business number [BUSINESS_NUMBER]), P.O. Box 34086, Calgary RPO Westbrook, Alberta, Canada T3C 3W2. The individual responsible for privacy enquiries can be reached at privacy@madeforstream.com. This policy explains personal information handled through accounts, creator applications, listings, messaging, projects, payments and support.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Information: Payments; Examples and sources: Transaction and connected-account IDs, amounts, currency, fee, contribution and tax breakdowns, payment status, refund and dispute records, and limited payment-method information made available by Stripe",
      "Information: Tax location evidence; Examples and sources: The billing country you choose at checkout and, where available, the country associated with your IP address and the country of the card used, recorded to work out where tax applies. Only the country is kept, never the IP address or card details",
      ...
      "Information: Choices and acceptance records; Examples and sources: Terms version and time of acceptance, a request to start work before a cancellation period ends, privacy preferences, cookie choices and marketing consent where applicable",
  ...
  },
  {
    ...
    "body": [
      ...
      "We use service providers for hosting, databases, authentication, payments and email. Made for Stream uses Supabase for account, authentication and database functions; Google Cloud to run our application server; Stripe for payment and connected-account services and, where tax is calculated, Stripe Tax; and Cloudflare for our domain, inbound email routing and outbound service email. Our fonts are served from our own site, so loading a page does not send requests to Google Fonts. Each provider, what it does and where it processes information is listed in the Service Provider Register (/policies/service-providers). A new provider is added to the register before it processes personal information. We share only what is needed for the stated service and require appropriate safeguards.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Made for Stream does not sell personal information or share it for cross-context behavioural advertising under the current service model. Before introducing advertising arrangements that change that position, we must provide the applicable disclosures and choices, honour legally required opt-out signals and obtain consent where needed. Future advertising plans are not a statement that tracking is currently active."
    ]
  },
  {
    ...
    "body": [
      ...
      "Record: Financial records, tax location evidence, accepted project terms and payment-dispute evidence; Ordinary retention: Seven years after the relevant transaction or final dispute resolution, whichever is later",
  ...
  },
  {
    ...
    "body": [
      "Contact privacy@madeforstream.com to request access, correction, deletion, restriction, portability, withdrawal of consent or objection where applicable. You may update many profile fields in account settings. We verify identity proportionately and do not ask for more information than reasonably needed. An authorised representative may act where the law permits.",
  ...
  },
  {
    ...
    "body": [
      ...
      "We publish the effective date and material changes. Where required, we obtain new consent before a new use begins. The Service Provider Register is published at /policies/service-providers, and privacy enquiries go to privacy@madeforstream.com. If an EU or UK representative or other jurisdiction-specific notice is legally required, its actual details must be added before offering the service on that basis."
    ]
  }
] as const;
