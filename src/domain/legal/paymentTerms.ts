...
export const paymentTermsSections = [
  {
    ...
    "body": [
      ...
      "Charge: Creator tip; Rate: Optional amount chosen by the buyer; Minimum per successful base payment: No Made for Stream percentage or minimum fee on the tip",
      "Charge: Made for Stream support; Rate: Optional amount chosen by the buyer, paid to Made for Stream; Minimum per successful base payment: No additional Made for Stream percentage or minimum fee on the contribution",
  ...
  },
  {
    ...
    "body": [
      "Fees apply separately to each successful base payment, including a deposit, milestone, balance or separately paid change order. For CAD and USD, calculate 5% and round up to the next cent, then apply the relevant minimum. Failed attempts and retrying the same unpaid obligation do not create additional Made for Stream fees. Each separately collected instalment can incur a minimum, so splitting a project can cost more than one payment.",
      "The agreement must show the payment schedule and estimated aggregate Made for Stream fees before acceptance. A creator cannot add instalments to an accepted schedule without buyer agreement. Refunds use the original fee amounts and the refund policy's proportional formula; minimums are not recalculated on the remaining balance."
    ]
  },
  {
    "title": "3. Examples",
    "body": [
      ...
      "Example: CAD 10 base, one payment; Buyer pays: CAD 11; Creator receives before Stripe costs: CAD 8.50; Made for Stream allocation: CAD 2.50",
      "Example: CAD 20 base, one payment; Buyer pays: CAD 21; Creator receives before Stripe costs: CAD 18.50; Made for Stream allocation: CAD 2.50",
      "Example: CAD 20 base, two CAD 10 payments; Buyer pays: CAD 22 total; Creator receives before Stripe costs: CAD 17 total; Made for Stream allocation: CAD 5 total",
  ...
  },
  {
    ...
    "body": [
      "A creator tip goes to the creator's allocation and is excluded from both Made for Stream fee calculations. Stripe processing or other provider costs may still apply. “Fee-exempt tip” means exempt from Made for Stream's fees, not a guarantee that the creator receives the tip without any processor costs.",
